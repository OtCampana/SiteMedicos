...
namespace login.Controllers
{
    public class EspecialidadesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,EspecialidadeNome")] Especialidade especialidade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,EspecialidadeNome")] Especialidade especialidade)
        {
            if (ModelState.IsValid)
            {
